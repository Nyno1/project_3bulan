<x-app-layout>
    ...
    >
    <div class="py-12 bg-gradient-to-br from-indigo-50 via-white to-blue-50">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="backdrop-blur-lg bg-white/80 shadow-2xl border border-gray-200 rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-indigo-200/50">
                <div class="p-8 sm:px-16 bg-gradient-to-br from-white/90 to-indigo-50/90 border-b border-gray-200">
                    ...
                    {{-- Alert Success --}}
                    @if (session('success'))
                    <div class="bg-green-100 border border-green-400 text-green-800 px-4 py-3 rounded-xl relative mb-6 shadow-sm animate-fade-in">
                    ...
                    {{-- Alert Error --}}
                    @if (session('error'))
                    <div class="bg-red-100 border border-red-400 text-red-800 px-4 py-3 rounded-xl relative mb-6 shadow-sm animate-fade-in">
